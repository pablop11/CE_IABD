...
def main():
    ...
    results = model.train(
        data="content/datasets/dataset_masas_agua/data.yaml",  # Ruta a tu dataset
    ...
    test_img_path = "content/datasets/masas_agua/images/test/imagen_1.jpg"  # CAMBIAR POR UNA IMAGEN REAL
